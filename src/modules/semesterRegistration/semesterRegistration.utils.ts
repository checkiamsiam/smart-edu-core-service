const getAvailableCourses = (offeredCourses: any, studentCompletedCourses: any, studentCurrentlyTakanCourses: any) => {
  ...
  const availableCoursesList = offeredCourses
    ...
    .map((course: any) => {
      const isAlreadyTakenCourse = studentCurrentlyTakanCourses.find((c: any) => c.offeredCourseId === course.id);
