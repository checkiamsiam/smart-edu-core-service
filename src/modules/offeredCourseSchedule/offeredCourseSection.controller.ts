...
const createOfferedCourseClassSchedule: RequestHandler = catchAsyncErrors(
...
const getOfferedCourseClassSchedules: RequestHandler = catchAsyncErrors(
  async (req: Request, res: Response) => {
    const getResult =
      await offeredCourseClassScheduleService.getOfferedCourseClassSchedule(
        req.queryFeatures
      );
...
const getSingleOfferedCourseClassSchedule: RequestHandler = catchAsyncErrors(
  async (req: Request, res: Response) => {
    ...
    if (!result) {
      throw new AppError(
        "offered course class schedule Not Found",
...
const updateOfferedCourseClassSchedule: RequestHandler = catchAsyncErrors(
  async (req: Request, res: Response) => {
    const id: string = req.params.id;
...
const deleteOfferedCourseClassSchedule: RequestHandler = catchAsyncErrors(
  async (req: Request, res: Response) => {
    const id: string = req.params.id;
