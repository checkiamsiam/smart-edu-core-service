...
const createStudentEnrolledCourse: RequestHandler = catchAsyncErrors(
...
const getStudentEnrolledCourses: RequestHandler = catchAsyncErrors(
  async (req: Request, res: Response) => {
    const getResult =
      await studentEnrolledCourseService.getStudentEnrolledCourses(
        req.queryFeatures
      );
...
const getSingleStudentEnrolledCourse: RequestHandler = catchAsyncErrors(
  async (req: Request, res: Response) => {
...
const updateStudentEnrolledCourse: RequestHandler = catchAsyncErrors(
  async (req: Request, res: Response) => {
    const id: string = req.params.id;
...
const deleteStudentEnrolledCourse: RequestHandler = catchAsyncErrors(
  async (req: Request, res: Response) => {
    const id: string = req.params.id;
