...
const getStudentEnrolledCourseMarks: RequestHandler = catchAsyncErrors(
  async (req: Request, res: Response) => {
    const getResult =
      await studentEnrolledCourseMarkService.getStudentEnrolledCourseMarks(
        req.queryFeatures
      );
...
const updateStudentMarks = catchAsyncErrors(
  async (req: Request, res: Response) => {
...
const updateFinalMarks = catchAsyncErrors(
  async (req: Request, res: Response) => {
...
const getMyCourseMarks = catchAsyncErrors(
  async (req: Request, res: Response) => {
