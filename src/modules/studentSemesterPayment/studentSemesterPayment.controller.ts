...
const getStudentSemesterPayments: RequestHandler = catchAsyncErrors(async (req: Request, res: Response) => {
  const getResult = await studentSemesterPaymentService.getStudentSemesterPayments(req.queryFeatures);
