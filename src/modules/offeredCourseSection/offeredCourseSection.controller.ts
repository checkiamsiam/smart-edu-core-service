...
const getOfferedCourseSections: RequestHandler = catchAsyncErrors(async (req: Request, res: Response) => {
  const getResult = await offeredCourseSectionService.getOfferedCourseSection(req.queryFeatures);
...
const getSingleOfferedCourseSection: RequestHandler = catchAsyncErrors(async (req: Request, res: Response) => {
  const id: string = req.params.id;
  const result: Partial<OfferedCourseSection> | null = await offeredCourseSectionService.getSingleOfferedCourseSection(id, req.queryFeatures);
  if (!result) {
...
const updateOfferedCourseSection: RequestHandler = catchAsyncErrors(async (req: Request, res: Response) => {
  const id: string = req.params.id;
  const updatePayload: Partial<OfferedCourseSection> = req.body;

  const result: Partial<OfferedCourseSection> | null = await offeredCourseSectionService.updateOfferedCourseSection(id, updatePayload);
...
const deleteOfferedCourseSection: RequestHandler = catchAsyncErrors(async (req: Request, res: Response) => {
  const id: string = req.params.id;
